...
export const SWAP_PROGRAM_OWNER_FEE_ADDRESS = process.env.REACT_APP_SWAP_PROGRAM_OWNER_FEE_ADDRESS ? new PublicKey(`${process.env.REACT_APP_SWAP_PROGRAM_OWNER_FEE_ADDRESS}`) : undefined;
...
export const PROGRAM_IDS = [
    {
        name: 'mainnet-beta',
        swap: () => ({
            current: new PublicKey('6pr836RnCpXYGaBAbvEW8dQWXJem87511yeRTPYeCB9r'),
            legacy: [
